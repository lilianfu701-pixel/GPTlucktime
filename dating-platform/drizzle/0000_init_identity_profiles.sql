...
CREATE TABLE "profiles" (
	...
	CONSTRAINT "profiles_country_code_length_check" CHECK (char_length("profiles"."country_code") = 2)
);
--> statement-breakpoint
...
CREATE INDEX "profile_photos_profile_position_idx" ON "profile_photos" USING btree ("profile_id","position");--> statement-breakpoint
